...
export const MovieProvider = ({ children }) => {
  ...
  const getUserMovies = async (userId) => {
    try {
      ...
      // Fetch ALL movies for admin users
  ...
  const updateMovie = async (movieData) => {
    try {
      const response = await axios.put(`/admin/movies/${movieData.id}`, movieData, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
          "Content-Type": "application/json",
        },
  ...
  const deleteMovie = async (movieId) => {
    try {
      await axios.delete(`/admin/movies/${movieId}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
  ...
  const deleteCasts = async (movieId) => {
    try {
      await axios.delete(`/admin/casts?movieId=${movieId}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
  ...
  const deletePhotos = async (movieId) => {
    try {
      await axios.delete(`/admin/photos?movieId=${movieId}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
  ...
  const deleteVideos = async (movieId) => {
    try {
      await axios.delete(`/admin/videos?movieId=${movieId}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
