...
const Movies = ({ showIndicator, hideIndicator }) => {
...
const MoviesWithProvider = ({ showIndicator, hideIndicator }) => {
  return (
    <DeleteMovieProvider>
      <DeleteCastProvider>
        <DeletePhotosProvider>
          <DeleteVideosProvider>
            <UpdateVideosProvider>
              <UpdateCastsProvider>
                <Movies showIndicator={showIndicator} hideIndicator={hideIndicator} />
              </UpdateCastsProvider>
            </UpdateVideosProvider>
          </DeleteVideosProvider>
        </DeletePhotosProvider>
